...
The project includes shared guardrails to prevent uncontrolled execution and oversized inputs during the RAG workflow.
...
The RAG assessment therefore uses the same guardrail approach across the pipeline while keeping the individual ingestion, indexing, retrieval, refusal, and evaluation files focused on their main responsibilities.
